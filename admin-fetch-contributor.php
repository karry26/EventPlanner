	...
	<script>
		...
		module.controller("mycontroller", function($scope, $http) {
			...
			$scope.doFetchAll = function() {
				$scope.jsonAry;
				$http.get("admin-fetch-contributor-process.php").then(fine, notfine);
		...
		<details>
			...
			<table class="table table-striped">
				...
				<tr ng-repeat="oneObj in jsonAry">
					...
					<td>{{oneObj.state}}</td>
					<td>
						<a href="uploads/{{oneObj.pic1}}" target="_blank">
							<img src="uploads/{{oneObj.pic1}}" width="50" height="50" alt="">
						</a>
					</td>
				<!--	<td>
